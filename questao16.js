...
import { get_number, get_string, calcular_preco_carne} from "./utils/io_utils.js"

function main () {
    //entrada
    console.log('---------------- FRIGORIFICO DO JOTA -----------------')
    let tipo_carne = get_string('Qual o tipo de carne? [File, Alcatra e Picanha]: ')
    let qtd_carne = get_number('Informe a quatidade de carne em kg: ')
    let tipo_pagamento = get_string('Vai pagar com o cartao Tabajara [S/N]? ')
    console.log('')

    //processamento e saida
    calcular_preco_carne(tipo_carne, qtd_carne, tipo_pagamento)
}
